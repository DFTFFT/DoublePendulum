...
class Ui_AboutDialog(QtGui.QDialog):
    ...
    def setupUi(self, AboutDialog):
        ...
        self.label.setGeometry(QtCore.QRect(60, 30, 270, 30))
        font = QtGui.QFont()
    ...
    def retranslateUi(self, AboutDialog):
        ...
        self.label.setText(_translate("AboutDialog", "Visualization of Double Pendulums", None))
        ...
        self.label_2.setText(_translate("AboutDialog", "Copyright@2016", None))
